      ...
      <section ref={ref} className="py-16 bg-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-dark mb-6">Contact Information</h2>
                ...
                <div className="mt-8">
                  ...
                  <div className="flex space-x-4">
                    <a href="#" className="bg-gray-100 p-3 rounded-full hover:bg-gray-200 transition-colors">
                      <svg className="h-5 w-5 text-dark" fill="currentColor" viewBox="0 0 24 24">
            ...
            <motion.div
              ...
              className="bg-white rounded-xl shadow-lg p-8 border-t-4 border-accent"
            >
              ...
              <form className="space-y-6">
                <div>
                  ...
                  <input
                    type="text"
                    id="name"
                    className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-accent focus:border-accent transition-all"
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  type="submit"
                  className="w-full bg-accent text-light py-3 rounded-lg font-medium shadow-md hover:shadow-lg transition-all"
                >
                  Send Message
                </motion.button>
              </form>
          ...
          >
            <div className="h-96 w-full bg-gray-200 relative">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center p-6 bg-white rounded-lg shadow-md border-t-4 border-accent">
                  <MapPinIcon className="h-10 w-10 text-accent mx-auto mb-3" />
