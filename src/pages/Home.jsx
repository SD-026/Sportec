...
const Home = () => {
  ...
  return (
    <div className="overflow-hidden">
      {/* Hero Section */}
      <section ref={heroRef} className="relative pt-24 pb-12 md:pt-32 md:pb-20 bg-gradient-to-br from-blue-50 to-green-50">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            >
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-4">
                Connect. Play. <span className="bg-gradient-to-r from-blue-600 to-green-500 bg-clip-text text-transparent">Compete.</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="bg-gradient-to-r from-blue-600 to-green-500 text-white px-6 py-3 rounded-lg font-medium shadow-lg hover:shadow-xl transition-all"
                >
                  Get Started
                </motion.button>
                <motion.button
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">About Sportec</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="bg-white text-blue-600 px-8 py-3 rounded-lg font-bold shadow-lg hover:shadow-xl transition-all"
            >
